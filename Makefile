...
bayes:
	#rm -f *.npz
	/usr/bin/time -v disko_bayes --fov 155 --ms test_data/test.ms  --PNG --SVG --arcmin=100  --title 'bayes_tart' --sigma-v=0.2
...
cygnus:
	mprof run disko_bayes --fov 0.05 --ms /home/tim/astro/cyg2052.ms --SVG --FITS --arcmin 0.026 --nvis 2000 --title 'cygnus'
	mprof plot
