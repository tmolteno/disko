...
cygnus:
	/usr/bin/time -v disko_bayes --fov 0.05 --ms /home/tim/astro/cyg2052.ms --SVG --arcmin 0.1 --nvis 2000 --title 'cygnus'
...
tart:
	/usr/bin/time -v disko --fov 155 --ms ../tart2ms/test.ms --SVG --arcmin=30 --arcmax=90 --alpha=0.0025 --tikhonov  --title 'tart'
